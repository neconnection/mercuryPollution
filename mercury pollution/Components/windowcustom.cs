...
namespace mercuryPollution.Components
{
    public partial class windowcustom : Component
    {
        #region -- Свойста --
        ...
        private Dictionary<fStyle, windowcustomStyle> StylesDictionary; // Словарь вида: <Стиль из набора, Объект стиля с параметрами>
        private windowcustomStyle CurrentStyle; // Актуальный стиль, класс с его параметрамы
        ...
        public windowcustom(IContainer container)
        {
            DefineStyles();
        ...
        private void SaveNoneStyleConfig()
        {
            ...
            {
                windowcustomStyle NoneStyle = StylesDictionary[fStyle.None];
        ...
        private void SaveUserStyleConfig()
        {
            if (StylesDictionary.ContainsKey(fStyle.UserStyle) && StyleUsed == false)
            {
                ...
                windowcustomStyle UserStyle = StylesDictionary[fStyle.UserStyle];
